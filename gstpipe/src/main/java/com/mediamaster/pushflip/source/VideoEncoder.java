...
//                        break LOOP;		// out of while
                    ...
                    if (mBufferInfo.size != 0) {
                        //Log.i(TAG,".... ... mFirstPts timeUS:" + mBufferInfo.presentationTimeUs);//打印视频时间戳
                        if (mFirstPts < 0) {
                            mFirstPts = mBufferInfo.presentationTimeUs; //第一次的时间戳
                        }
...
//                    mBufferInfo.presentationTimeUs = getPTSUs();
                        ...
                        encodedData.limit(mBufferInfo.offset + mBufferInfo.size);//限制
                        ...
                        if (mBufferInfo.presentationTimeUs == 0) {
                            ...
                            Log.i(TAG, " video presentationTimeUs is zero");//视频的时间戳为
...
//                    }
                       ...
                       //  Log.i(TAG," .....encoderStatus 000001.... ");
                        mListener.onFrameAvalailable(encodedData, mBufferInfo.offset, mBufferInfo.size, mBufferInfo.flags,
                                mBufferInfo.presentationTimeUs - mFirstPts);      //减去第一次的时间戳
...
//                    );
                        prevOutputPTSUs = mBufferInfo.presentationTimeUs;        //前一帧时间戳
//					}
                    }
...
//        mTrackIndex = mMuxer.addTrack(videoTrackFormat);
//        mMuxer.start();
//        mMuxerStarted = true;
...
//        }
    ...
    private static final float BPP = 0.16f / 2;
    ...
    protected Surface prepare_surface_encoder(final String mime, final int frame_rate)
        ...
        //format.setInteger(MediaFormat.KEY_BIT_RATE, 512000);     // 995328   1990656     3584000   512000
        ...
        //init Muxer
        //mMuxer = new MediaMuxer("sdcard/game.mp4",MediaMuxer.OutputFormat.MUXER_OUTPUT_MPEG_4);
        //mTrackIndex = -1;
        //mMuxerStarted = false;
