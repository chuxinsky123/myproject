...
//            replayClient.
    ...
    public void SaveLogopicToSdcard( String bitName ){
        String sdPath =  Environment.getExternalStorageDirectory().getAbsolutePath();
        File f = new File( sdPath,bitName + ".png");
        if ( !f.exists() )
        {
            Bitmap bitmap_02 = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.my_logo);
            ...
            bitmap_02.compress(Bitmap.CompressFormat.PNG, 100, fOut);
            try {
                fOut.close();
            } catch (IOException e) {
                e.printStackTrace();
...
//
//    public void SaveLogopicToSdcard( Bitmap mBitmap, String bitName ){
//        String sdPath =  Environment.getExternalStorageDirectory().getAbsolutePath();
//        File f = new File( sdPath,bitName + ".png");
//        if ( !f.exists() )
//        {
...
//
    ...
    private Notification getNotification() {
        ...
        Notification notification = new Notification.Builder(mContext)
                .setContentTitle("GpusherTitle")
                .setContentText("GpusherContent")
