...
//    }
    ...
    public boolean prepare(Context appContext, String url, String roomId, String privateName,int width, int height, int bitrate, int dpi,MediaProjection mediaProjection,Bitmap bitmap) {
...
//        }
    ...
    public boolean conStart_Server(String rtmp_url, int width, int heigth, int bitrate) {
        ...
        if(!this.prepare(stat_Context, rtmp_url, room_id, "SystemDefaultPrivateData", width, heigth, bitrate,GpusherService.mDpi,GpusherService.mediaProjection,BitmapFactory.decodeResource(mContext.getResources(),R.drawable.my_logo))) {
