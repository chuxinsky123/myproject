...
public class Index extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //Log.i(TAG, "pushflip version " + GPusherConfig.version + " jni version " + getNativeVersion());
        ...
        //
        TextView mprivate_ratio_02 = (TextView) findViewById(R.id.index_privacy_mode_02);
        //mprivate_ratio.setVisibility(View.GONE);
        mprivate_ratio_02.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//        });
    ...
    private String getWatermark() {
        ...
        //Drawable drawable = getResource().getDrawable(R.drawable.watermark_log);
        return "";
    }
    ...
    public void startServer( View v )
    {
        ...
        mPusher = new Pusher();  //Pusher 初始化
        mPusher.regListener(mListener);
        //mPusher.info_log_count();
        //width = 704;
        //height = 400;
        ...
        height = 360; //720    360
        width = 640; //1280   640
        //rtmp://127.0.0.1/live/mada
        //Login.rtmp_url = "rtmp://192.168.3.163/live/madada789";   //demo Test url
        Log.i(TAG,"dizhi: " + Login.rtmp_url);
        if (mPusher.prepare(mAppContext, Login.rtmp_url,Room_id, PrivateDataMaker.SystemDefaultPrivateData, width, height, mBitrate,mScreenDensity, mediaProjection, BitmapFactory.decodeResource(this.getResources(), com.mediamaster.gstpipe.R.drawable.my_logo)) == false)
        //if (mPusher.prepare(mAppContext, Login.rtmp_url,Room_id, PrivateDataMaker.SystemDefaultPrivateData,"watermark.png",width, height, mBitrate,mScreenDensity, mediaProjection) == false)
        {
