...
//                String rtmp_uri =  "rtmp://123.59.63.4/g_live/songguangyu?key=d2b755c06e892172";
        ...
        if (mPusher.prepare(mAppContext, rtmp_uri,"000001", PrivateDataMaker.SystemDefaultPrivateData, width, height, mBitrate,1, mediaProjection, BitmapFactory.decodeResource(mContext.getResources(), com.mediamaster.gstpipe.R.drawable.my_logo)) == false) {
